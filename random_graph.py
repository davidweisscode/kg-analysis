...
def write_edgelist(classname, edgelist):
    ...
    df.to_csv(f"out/{classname}_r/{classname}_r.g.csv", index=False)
...
# Havel Hakimi model
    # High degree nodes connected with high degree nodes
    # High degree nodes connected with low degree nodes
...
add_results("my_run", "Manga_r",
            m_g=m_g, dens_g=dens_g, k_t=k_t, k_b=k_b)
